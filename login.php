...
<body>
	<div class="container">
            ...
            <div class="loginlabel"><h1>Авторизация</h1></div>
            <form class="inputs" action="signin.php" method="post">
            	<div>Логин&nbsp;&nbsp;&nbsp;<input type="text" name="login"></div>
            	<div>Пароль&nbsp;<input type="password" name="password"></div>
            	<input type="submit" style="background-color: #E21347; font-size: 25px; width: 150px; justify-self: center; color: white;" value="Войти">
            </form>
            <a href="registration.php" class="ssilka">Зарегистрироватся</a>
